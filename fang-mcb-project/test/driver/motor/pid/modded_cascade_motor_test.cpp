...
namespace fang::motor::ModdedCascadeMotorTest
{
    using namespace units::literals;
    using DoubleDualSmoothPid = trap::algorithms::DualModdedPid<double, double, double, Seconds>;
    ...
    class ModdedCascadeMotorMatchTest : public testing::TestWithParam<MatchTestParam>
    {
    protected:
        ...
        ModdedCascadeMotor<double, double, double> cascadeMotor{
            kParam.config,
     ...
     */
    TEST_P(ModdedCascadeMotorMatchTest, matchTest)
    {
    ...
    TEST(ModdedCascadeMotor, compilation)
    {
        ...
        ModdedCascadeMotor<double, double, double> cascadeMotor 
        {
            ModdedCascadeMotor<double, double, double>::Config{},
            std::move(motor),
            std::move(positionTelemetry),
            std::move(speedTelemetry)
        };
    ...
    TEST(ModdedCascadeMotor, initializeAndUpdate)
    {
        std::unique_ptr<OutputMotorMock> motor{std::make_unique<OutputMotorMock>()};
        std::unique_ptr<TelemetryMock> positionTelemetry{std::make_unique<TelemetryMock>()};
        std::unique_ptr<TelemetryMock> speedTelemetry{std::make_unique<TelemetryMock>()};
