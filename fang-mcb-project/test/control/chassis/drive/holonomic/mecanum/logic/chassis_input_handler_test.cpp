...
static const fang::chassis::DjiHolonomicInputHandler::RemoteConfig k_chassisInputRemoteConfig
{
    Channel::LEFT_HORIZONTAL,   //xTranslation
    Channel::LEFT_VERTICAL,     //yTranslation
    Channel::WHEEL              //rotation
};
static const fang::chassis::DjiHolonomicInputHandler::KeyboardConfig k_chassisInputKeyboardConfig
{
    Key::W, //forward
    Key::S, //backward
    Key::A, //left
...
static const fang::chassis::DjiHolonomicInputHandler::Config k_chassisInputConfig
{
...
protected:
    ...
    fang::chassis::DjiHolonomicInputHandler m_chassisInputHandler{m_remote, k_chassisInputConfig};
