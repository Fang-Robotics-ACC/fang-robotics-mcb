...
TEST(mecanumCalculator, forwardsTest)
{
    ...
    const chassis::QuadRPM test {1.0_rad_per_s, 1.0_rad_per_s, 1.0_rad_per_s, 1.0_rad_per_s};
    ...
    {
    chassis::MecanumCalculator calc{1.0_m, 1.0_m, 1.0_m};
    const chassis::QuadRPM test {1.5_rad_per_s, 1.5_rad_per_s, 1.5_rad_per_s, 1.5_rad_per_s};
...
TEST(backwardsTest, MecanumMotionCalculator )
{
    ...
    {
    chassis::MecanumCalculator calc{1.0_m, 1.0_m, 1.0_m};
    const chassis::QuadRPM test {-1000.534_rad_per_s, -1000.534_rad_per_s, -1000.534_rad_per_s, -1000.534_rad_per_s};
...
TEST(zeroTest, MecanumMotionCalculator)
{
    ...
    {
    chassis::MecanumCalculator calc{1.0_m, 1.0_m, 1.0_m};
    const chassis::QuadRPM test {0.0_rad_per_s, 0.0_rad_per_s, 0.0_rad_per_s, 0.0_rad_per_s};
    const chassis::Velocity2D expected{0.0_mps, 0.0_mps};
