#ifndef FANG_ROBOTICS_MCB_CONTROL_CHASSIS_MECANUM_LOGIC_ABSTRACT_FIELD_MECANUM_LOGIC_HPP
#define FANG_ROBOTICS_MCB_CONTROL_CHASSIS_MECANUM_LOGIC_ABSTRACT_FIELD_MECANUM_LOGIC_HPP
