#ifndef FANG_ROBOTICS_MCB_TURRET_SUBSYSTEM_BLUEPRINT_BASIC_FEEDER_SUBSYSTEM_HPP
#define FANG_ROBOTICS_MCB_TURRET_SUBSYSTEM_BLUEPRINT_BASIC_FEEDER_SUBSYSTEM_HPP
#include "basic_feeder_subsystem.hpp"
