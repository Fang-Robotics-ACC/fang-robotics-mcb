...
namespace fang::motor
{
     ...
     * (2nd pid)
     */
    template <typename Output, typename Control, typename Intermediate, typename Time = Seconds>
    ...
    public:
        ...
        using Pid = trap::algorithms::DualCascadePid<Control, Intermediate, Output, Time>;
